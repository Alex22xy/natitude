...
export default function ProfilePage() {
  ...
  useEffect(() => {
    const name = localStorage.getItem("natitude_name") || "Member";
    const handle = localStorage.getItem("natitude_handle") || "@ACCESS";
    setUser({ name, handle });
  ...
  const downloadCard = async () => {
    ...
    // Generates the image from the HTML element
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center px-6 pt-12 pb-24">
      {/* CARD CONTAINER (This is what gets saved) */}
