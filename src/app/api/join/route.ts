      ...
      <div style="max-width: 600px; margin: 0 auto; border: 1px solid #333; padding: 40px; background-color: #000;">
        ...
        <div style="line-height: 1.8; font-size: 14px; color: #fff;">
          ...
          <div style="margin-top: 60px; border-top: 1px solid #222; padding-top: 30px;">
            <p style="letter-spacing: 4px; font-size: 12px; color: #aaa; text-transform: uppercase;">
