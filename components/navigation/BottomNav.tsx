...
export default function BottomNav() {
  ...
  const navItems = [
  {
    ...
    path: "/",
    label: "Home",
    svg: <path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />, // Home Icon
  },
  {
    id: "the-wild",
    path: "/map",
    label: "The Wild",
    svg: <path d="m21 21-3.5-3.5M17 10a7 7 0 1 1-14 0 7 7 0 0 1 14 0Z" />, // Search/Map Icon
  },
  {
    id: "join",
    path: "/join",
    label: "Join",
    isAction: true,
    svg: <path d="M12 5v14M5 12h14" />, // Plus Icon
  },
  {
    id: "saved",
    path: "/event", // Adjust if your saved page is elsewhere
    label: "Saved",
    svg: <path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z" />, // Bookmark Icon
  },
  {
    id: "profile",
    path: "/profile",
    label: "Profile",
    svg: <path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" />, // Profile Icon
  },
];
